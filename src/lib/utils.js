          ...
          <div class="mb-4 bg-gray-50 p-3 rounded-lg">
            ...
            <div class="flex items-center justify-between flex-col">
              ...
              <div class="my-4 flex gap-2">
                ...
                <a href="${url}" download class="inline-flex items-center gap-1 px-3 py-1 text-sm bg-orange-500 text-white rounded hover:bg-orange-600 transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4">
            ...
            docInfo ? `• ${docInfo.size}` : ""
                    ...
                    <div class="flex flex-wrap gap-2">
                      ...
                      <a 
                        href="${url}" 
                        download
                        class="inline-flex items-center gap-1 px-3 py-1 text-sm bg-orange-500 text-white rounded hover:bg-orange-600 transition-colors"
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4">
                          <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/>
                          <polyline points="7 10 12 15 17 10"/>
